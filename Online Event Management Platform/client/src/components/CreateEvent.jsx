...
function CreateEvent() {
  ...
  const handleSubmit = async () => {
    try {
      let {message} = await AxiosService.post(ApiRoutes.CREATE_EVENT.path,{title, description, image, location, date, time, category}, {authenticate:ApiRoutes.CREATE_EVENT.auth})
